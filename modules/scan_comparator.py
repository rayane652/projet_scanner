...
def _compare_scan_pair(old_scan, new_scan):
    try:
        ...
        fixed_keys = keys_old - keys_new
        new_keys = keys_new - keys_old
        persistent_keys = keys_old & keys_new
        ...
        score_old = old_payload.get("risk_score", 50) or 50
        score_new = new_payload.get("risk_score", 50) or 50
